...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
       ...
       // string testConnect = @"Provider=SQLOLEDB.1;Integrated Security = SSPI; Persist Security Info=False;Initial Catalog = Northwind; Data Source = LAPTOP-9NI9ES32\SQLEXPRESS";
        ...
        {
            DBConnectionToolStripMenuItem.Enabled =
                (e.CurrentState == ConnectionState.Closed);
            stopConnectionToolStripMenuItem.Enabled =
